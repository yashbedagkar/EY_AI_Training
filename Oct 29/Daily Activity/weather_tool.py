# ============================================================
# Memory-Tools.py — Conversational Mistral Agent (with weather tool)
# ============================================================
...
def weather(city: str) -> str:
    """Return simulated weather info for a given city."""
    conditions = {
...
while True:
    ...
    if user_input.lower().startswith("weather"):
        try:
            ...
            report = weather(city)
            print("Agent:", report)
            memory.save_context({"input": user_input}, {"output": report})
            continue
        except Exception as e:
            print("Agent: Could not fetch weather:", e)
            continue
